...
namespace ULTankZombies
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            //Esta parte del c�digo es para activar el gameover, tanto para cuando se gana o pierde detectando si el tanque fue destruido o si los mausoleos fueron destruidos
            ...
            //A�ade los booleanos para que el juego sepa que los mausoleos fueron destruidos.
            ...
            //Detecta si hay una horda en progreso buscando el tag de horda, si aun hay un zombie de horda vivo, la nueva horda no se iniciar� hasta que todos los zombies de la horda se destruyan
            ...
            //Activaci�n del countdown de la Horda.
